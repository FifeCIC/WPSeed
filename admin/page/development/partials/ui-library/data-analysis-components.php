...
<div class="wpseed-ui-section">
    <h3><?php esc_html_e('Data Analysis Components', 'wpseed'); ?></h3>
    <p><?php esc_html_e('Components for displaying trading data, metrics, and statistical analysis using existing wpseed styles.', 'wpseed'); ?></p>
    
    <div class="wpseed-component-group">
        <!-- Metric Cards Grid -->
        <div class="component-demo">
            <h4><?php esc_html_e('Trading Metrics Cards', 'wpseed'); ?></h4>
            <div class="wpseed-component-showcase">
                <div class="wpseed-grid wpseed-grid-3-cols">
                    <div class="wpseed-card">
                        <div class="wpseed-card-header">
                            <h5><?php esc_html_e('Portfolio Value', 'wpseed'); ?></h5>
                    ...
                    <div class="wpseed-card">
                        <div class="wpseed-card-header">
                            <h5><?php esc_html_e('Daily P&L', 'wpseed'); ?></h5>
                    ...
                    <div class="wpseed-card">
                        <div class="wpseed-card-header">
                            <h5><?php esc_html_e('Win Rate', 'wpseed'); ?></h5>
        ...
        <!-- Statistics Table -->
        <div class="component-demo">
            <h4><?php esc_html_e('Trading Statistics Table', 'wpseed'); ?></h4>
            <div class="wpseed-component-showcase">
                <div class="wpseed-table-wrapper">
                    <table class="wpseed-table">
                        <thead>
                            <tr>
                                <th><?php esc_html_e('Symbol', 'wpseed'); ?></th>
                                <th><?php esc_html_e('Position', 'wpseed'); ?></th>
                                <th><?php esc_html_e('Entry Price', 'wpseed'); ?></th>
                                <th><?php esc_html_e('Current Price', 'wpseed'); ?></th>
                                <th><?php esc_html_e('P&L', 'wpseed'); ?></th>
                                <th><?php esc_html_e('Score', 'wpseed'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <span class="wpseed-badge wpseed-badge-success"><?php esc_html_e('LONG', 'wpseed'); ?></span>
                                    100 shares
                                </td>
                                <td>$155.25</td>
                                <td>$168.40</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="wpseed-badge wpseed-badge-error"><?php esc_html_e('SHORT', 'wpseed'); ?></span>
                                    50 shares
                                </td>
                                <td>$245.80</td>
                                <td>$238.15</td>
        ...
        <!-- KPI Dashboard -->
        <div class="component-demo">
            <h4><?php esc_html_e('KPI Dashboard', 'wpseed'); ?></h4>
            <div class="wpseed-component-showcase">
                <div class="kpi-dashboard">
                    <div class="kpi-section">
                        <h5><?php esc_html_e('Performance Metrics', 'wpseed'); ?></h5>
                        <div class="kpi-grid">
                            <div class="kpi-item">
                                <div class="kpi-label"><?php esc_html_e('Total Return', 'wpseed'); ?></div>
                                <div class="kpi-value positive">+24.8%</div>
                                <div class="kpi-subtext"><?php esc_html_e('vs S&P 500: +18.2%', 'wpseed'); ?></div>
                            </div>
                            <div class="kpi-item">
                                <div class="kpi-label"><?php esc_html_e('Sharpe Ratio', 'wpseed'); ?></div>
                                <div class="kpi-value">1.42</div>
                                <div class="kpi-subtext"><?php esc_html_e('Risk-adjusted return', 'wpseed'); ?></div>
                            </div>
                            <div class="kpi-item">
                                <div class="kpi-label"><?php esc_html_e('Max Drawdown', 'wpseed'); ?></div>
                                <div class="kpi-value negative">-8.3%</div>
                                <div class="kpi-subtext"><?php esc_html_e('Peak to trough', 'wpseed'); ?></div>
                            </div>
                            <div class="kpi-item">
                                <div class="kpi-label"><?php esc_html_e('Beta', 'wpseed'); ?></div>
                                <div class="kpi-value">0.85</div>
                                <div class="kpi-subtext"><?php esc_html_e('Market correlation', 'wpseed'); ?></div>
                            </div>
                        </div>
                    </div>
                    
                    <div class="kpi-section">
                        <h5><?php esc_html_e('Trading Activity', 'wpseed'); ?></h5>
                        <div class="kpi-grid">
                            <div class="kpi-item">
                                <div class="kpi-label"><?php esc_html_e('Total Trades', 'wpseed'); ?></div>
                            ...
                            <div class="kpi-item">
                                <div class="kpi-label"><?php esc_html_e('Avg Hold Time', 'wpseed'); ?></div>
                                <div class="kpi-value">3.2 days</div>
                                <div class="kpi-subtext"><?php esc_html_e('Target: 2-5 days', 'wpseed'); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Comparison Table -->
        <div class="component-demo">
            <h4><?php esc_html_e('Strategy Comparison', 'wpseed'); ?></h4>
            <div class="wpseed-component-showcase">
                <div class="comparison-table-wrapper">
                    <table class="wpseed-table comparison-table">
                        <thead>
                            <tr>
                                <th><?php esc_html_e('Strategy', 'wpseed'); ?></th>
                                <th><?php esc_html_e('Return', 'wpseed'); ?></th>
                                <th><?php esc_html_e('Win Rate', 'wpseed'); ?></th>
                                <th><?php esc_html_e('Max DD', 'wpseed'); ?></th>
                                <th><?php esc_html_e('Sharpe', 'wpseed'); ?></th>
                                <th><?php esc_html_e('Status', 'wpseed'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="comparison-row">
                                <td><strong><?php esc_html_e('Momentum Breakout', 'wpseed'); ?></strong></td>
                            ...
                            <tr class="comparison-row">
                                <td><strong><?php esc_html_e('Mean Reversion', 'wpseed'); ?></strong></td>
                                ...
                                <td>1.42</td>
                                <td><span class="wpseed-badge wpseed-badge-warning"><?php esc_html_e('Testing', 'wpseed'); ?></span></td>
                            </tr>
                            <tr class="comparison-row">
                                <td><strong><?php esc_html_e('Trend Following', 'wpseed'); ?></strong></td>
                                ...
                                <td>1.28</td>
                                <td><span class="wpseed-badge wpseed-badge-info"><?php esc_html_e('Paused', 'wpseed'); ?></span></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <!-- Analytics Summary -->
        <div class="component-demo">
            <h4><?php esc_html_e('Analytics Summary Panel', 'wpseed'); ?></h4>
            <div class="wpseed-component-showcase">
                <div class="analytics-summary">
                    <div class="analytics-header">
                        <h5><?php esc_html_e('Portfolio Analytics', 'wpseed'); ?></h5>
                        <div class="analytics-controls">
                            <select class="wpseed-select wpseed-select-small">
                                <option value="1d"><?php esc_html_e('1 Day', 'wpseed'); ?></option>
                                <option value="1w" selected><?php esc_html_e('1 Week', 'wpseed'); ?></option>
                                <option value="1m"><?php esc_html_e('1 Month', 'wpseed'); ?></option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="analytics-metrics">
                            <div class="analytics-metric">
                                ...
                                <div class="metric-data">
                                    <div class="metric-label"><?php esc_html_e('Volatility', 'wpseed'); ?></div>
                                    <div class="metric-value">18.4%</div>
                                    <div class="metric-trend">
                                        <span class="dashicons dashicons-arrow-down-alt"></span>
                                        <span><?php esc_html_e('Decreasing', 'wpseed'); ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="analytics-metric">
                                ...
                                <div class="metric-data">
                                    <div class="metric-label"><?php esc_html_e('Alpha', 'wpseed'); ?></div>
                                    <div class="metric-value positive">+4.2%</div>
                                    <div class="metric-trend">
                                        <span class="dashicons dashicons-arrow-up-alt"></span>
                                        <span><?php esc_html_e('Outperforming', 'wpseed'); ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="analytics-metric">
                                ...
                                <div class="metric-data">
                                    <div class="metric-label"><?php esc_html_e('Correlation', 'wpseed'); ?></div>
