...
class WPSeed_Admin_Development_PHPInfo {
    public static function output() {
        ...
        <div class="wpseed-dev-section">
            <h2><?php _e('PHP Configuration', 'wpseed'); ?></h2>
            
            <table class="widefat">
                <tbody>
                    <tr>
                        <th><?php _e('PHP Version', 'wpseed'); ?></th>
                        <td><?php echo esc_html(PHP_VERSION); ?></td>
                    </tr>
                    <tr>
                        <th><?php _e('Memory Limit', 'wpseed'); ?></th>
                        <td><?php echo esc_html(ini_get('memory_limit')); ?></td>
                    </tr>
                    <tr>
                        <th><?php _e('Max Execution Time', 'wpseed'); ?></th>
                        <td><?php echo esc_html(ini_get('max_execution_time')); ?> seconds</td>
                    </tr>
                    <tr>
                        <th><?php _e('Max Upload Size', 'wpseed'); ?></th>
                        <td><?php echo esc_html(ini_get('upload_max_filesize')); ?></td>
                    </tr>
                    <tr>
                        <th><?php _e('Max Post Size', 'wpseed'); ?></th>
                        <td><?php echo esc_html(ini_get('post_max_size')); ?></td>
                    </tr>
                    <tr>
                        <th><?php _e('Display Errors', 'wpseed'); ?></th>
                        <td><?php echo ini_get('display_errors') ? __('On', 'wpseed') : __('Off', 'wpseed'); ?></td>
                    </tr>
                </tbody>
            </table>

            <h3><?php _e('Loaded Extensions', 'wpseed'); ?></h3>
