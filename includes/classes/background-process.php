...
abstract class WPSeed_Background_Process extends WPSeed_Async_Request {
    ...
    protected function is_process_running() {
        return get_site_transient( $this->identifier . '_process_lock' ) ? true : false;
    }
    ...
    protected function memory_exceeded() {
        ...
        return apply_filters( $this->identifier . '_memory_exceeded', $current_memory >= $memory_limit );
    }
    ...
    protected function time_exceeded() {
        ...
        return apply_filters( $this->identifier . '_time_exceeded', time() >= $finish );
    }
