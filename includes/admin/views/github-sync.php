...
<div class="wrap wpseed-github-sync">
    <h1><?php _e('GitHub Documentation Sync', 'wpseed'); ?></h1>
    
    <?php if (empty($this->github_token) || empty($this->github_repo)): ?>
        <div class="notice notice-warning">
            <p><strong><?php _e('Configuration Required', 'wpseed'); ?></strong></p>
            <p><?php _e('Set GitHub token and repo in Settings to enable sync.', 'wpseed'); ?></p>
        </div>
    <?php endif; ?>
    
    <div class="wpseed-sync-status">
        <h2><?php _e('Documentation Files', 'wpseed'); ?></h2>
        
        <table class="wp-list-table widefat fixed striped">
            <thead>
                <tr>
                    <th><?php _e('File', 'wpseed'); ?></th>
                    <th><?php _e('Status', 'wpseed'); ?></th>
                    <th><?php _e('Last Modified', 'wpseed'); ?></th>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($file_status['synced']): ?>
                                ...
                                <?php _e('Synced', 'wpseed'); ?>
                            <?php else: ?>
                                <span class="dashicons dashicons-warning" style="color: orange;"></span>
                                <?php _e('Needs Sync', 'wpseed'); ?>
                            <?php endif; ?>
                        </td>
