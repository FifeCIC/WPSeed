...
<div class="wpseed-ui-section">
    <h3><?php esc_html_e('Tooltips', 'wpseed'); ?></h3>
    <p><?php esc_html_e('Contextual information displays for trading data, technical indicators, and user guidance using existing wpseed styles.', 'wpseed'); ?></p>
    
    <div class="wpseed-component-group">
        <!-- Basic Tooltips -->
        <div class="component-demo">
            <h4><?php esc_html_e('Basic Tooltips', 'wpseed'); ?></h4>
            <div class="wpseed-component-showcase">
                <div class="tooltip-examples">
                    <div class="tooltip-item">
                        <span class="tooltip-trigger" data-tooltip="<?php esc_attr_e('This is a basic tooltip with simple information', 'wpseed'); ?>">
                            <?php esc_html_e('Hover for basic tooltip', 'wpseed'); ?>
                            <span class="dashicons dashicons-info"></span>
                        </span>
                    </div>
                    
                    <div class="tooltip-item">
                        <span class="tooltip-trigger tooltip-warning" data-tooltip="<?php esc_attr_e('Warning: High volatility detected in this symbol', 'wpseed'); ?>">
                            <?php esc_html_e('Warning tooltip', 'wpseed'); ?>
                            <span class="dashicons dashicons-warning"></span>
                        </span>
                    </div>
                    
                    <div class="tooltip-item">
                        <span class="tooltip-trigger tooltip-success" data-tooltip="<?php esc_attr_e('Success: Order executed successfully', 'wpseed'); ?>">
                            <?php esc_html_e('Success tooltip', 'wpseed'); ?>
                            <span class="dashicons dashicons-yes-alt"></span>
                        </span>
                    </div>
                    
                    <div class="tooltip-item">
                        <span class="tooltip-trigger tooltip-error" data-tooltip="<?php esc_attr_e('Error: Insufficient funds for this trade', 'wpseed'); ?>">
                            <?php esc_html_e('Error tooltip', 'wpseed'); ?>
        ...
        <div class="component-demo">
            <h4><?php esc_html_e('Trading Data Tooltips', 'wpseed'); ?></h4>
            <div class="wpseed-component-showcase">
                <div class="trading-metrics-grid">
                    <div class="metric-card">
                        <div class="metric-header">
                            <span class="metric-label"><?php esc_html_e('RSI', 'wpseed'); ?></span>
                            <span class="tooltip-trigger" data-tooltip="<?php esc_attr_e('Relative Strength Index (RSI) measures momentum. Values above 70 suggest overbought conditions, below 30 suggest oversold conditions.', 'wpseed'); ?>">
                    ...
                    <div class="metric-card">
                        <div class="metric-header">
                            <span class="metric-label"><?php esc_html_e('MACD', 'wpseed'); ?></span>
                            <span class="tooltip-trigger" data-tooltip="<?php esc_attr_e('Moving Average Convergence Divergence (MACD) is a trend-following momentum indicator. Current value shows bullish momentum.', 'wpseed'); ?>">
                                <span class="dashicons dashicons-info-outline"></span>
                            </span>
                        </div>
                    ...
                    <div class="metric-card">
                        <div class="metric-header">
                            <span class="metric-label"><?php esc_html_e('Beta', 'wpseed'); ?></span>
                            <span class="tooltip-trigger" data-tooltip="<?php esc_attr_e('Beta measures volatility relative to the market. Beta > 1 means more volatile than market, Beta < 1 means less volatile.', 'wpseed'); ?>">
                                <span class="dashicons dashicons-info-outline"></span>
                            </span>
                        </div>
        ...
        <div class="component-demo">
            <h4><?php esc_html_e('Rich Content Tooltips', 'wpseed'); ?></h4>
            <div class="wpseed-component-showcase">
                ...
                <div class="rich-tooltip-templates" style="display: none;">
                    <div class="rich-tooltip-content" data-template="AAPL">
                        ...
                        <div class="tooltip-metrics">
                            <div class="tooltip-metric">
                                <span class="metric-name"><?php esc_html_e('Market Cap:', 'wpseed'); ?></span>
                                <span class="metric-value">$2.85T</span>
                            </div>
                            <div class="tooltip-metric">
                                <span class="metric-name"><?php esc_html_e('P/E Ratio:', 'wpseed'); ?></span>
                                <span class="metric-value">28.5</span>
                            </div>
                            <div class="tooltip-metric">
                                <span class="metric-name"><?php esc_html_e('Volume:', 'wpseed'); ?></span>
                                <span class="metric-value">45.2M</span>
                            </div>
                        </div>
                        <div class="tooltip-footer">
                            <small><?php esc_html_e('Last updated: 2 minutes ago', 'wpseed'); ?></small>
                        </div>
                    </div>
                    ...
                    <div class="rich-tooltip-content" data-template="TSLA">
                        ...
                        <div class="tooltip-footer">
                            <small><?php esc_html_e('Last updated: 1 minute ago', 'wpseed'); ?></small>
                        </div>
                    </div>
                    ...
                    <div class="rich-tooltip-content" data-template="MSFT">
                        ...
                        <div class="tooltip-footer">
                            <small><?php esc_html_e('Last updated: 3 minutes ago', 'wpseed'); ?></small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="wpseed-component-showcase">
                <div class="interactive-tooltip-examples">
                    ...
                    <div class="tooltip-item">
                        <span class="interactive-tooltip-trigger" data-tooltip-content="risk-settings">
                            <?php esc_html_e('Risk Settings', 'wpseed'); ?>
                    ...
                    <div class="tooltip-item">
                        <span class="interactive-tooltip-trigger" data-tooltip-content="api-status">
                            <?php esc_html_e('API Status', 'wpseed'); ?>
                ...
                <div class="interactive-tooltip-templates" style="display: none;">
                    <div class="interactive-tooltip-content" data-content="strategy-help">
                        <div class="tooltip-header">
                            <strong><?php esc_html_e('Strategy Configuration', 'wpseed'); ?></strong>
                        </div>
                        <div class="tooltip-body">
                            <p><?php esc_html_e('Configure your trading strategy parameters:', 'wpseed'); ?></p>
                            <ul>
                                <li><?php esc_html_e('Set entry and exit conditions', 'wpseed'); ?></li>
                                <li><?php esc_html_e('Define risk management rules', 'wpseed'); ?></li>
                                <li><?php esc_html_e('Configure position sizing', 'wpseed'); ?></li>
                            </ul>
                        </div>
                    ...
                    <div class="interactive-tooltip-content" data-content="risk-settings">
                        <div class="tooltip-header">
                            <strong><?php esc_html_e('Risk Management', 'wpseed'); ?></strong>
                        </div>
                        <div class="tooltip-body">
                            <div class="tooltip-metric">
                                <span class="metric-name"><?php esc_html_e('Max Risk per Trade:', 'wpseed'); ?></span>
                                <span class="metric-value">2%</span>
                            </div>
                            <div class="tooltip-metric">
                                <span class="metric-name"><?php esc_html_e('Daily Loss Limit:', 'wpseed'); ?></span>
                                <span class="metric-value">5%</span>
                            </div>
                            <div class="tooltip-metric">
                                <span class="metric-name"><?php esc_html_e('Position Size:', 'wpseed'); ?></span>
                    ...
                    <div class="interactive-tooltip-content" data-content="api-status">
                        <div class="tooltip-header">
                            <strong><?php esc_html_e('API Connection Status', 'wpseed'); ?></strong>
                        </div>
                        <div class="tooltip-body">
                            <div class="api-status-list">
                                <div class="api-status-item">
                                    <span class="status-dot status-connected"></span>
                                    <span class="api-name"><?php esc_html_e('Alpha Vantage', 'wpseed'); ?></span>
                                    <span class="api-status"><?php esc_html_e('Connected', 'wpseed'); ?></span>
                                </div>
                                <div class="api-status-item">
                                    <span class="status-dot status-warning"></span>
                                    <span class="api-name"><?php esc_html_e('Trading Platform', 'wpseed'); ?></span>
                                    <span class="api-status"><?php esc_html_e('Limited', 'wpseed'); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="tooltip-actions">
        ...
        <!-- Positional Tooltips -->
        <div class="component-demo">
            <h4><?php esc_html_e('Tooltip Positioning', 'wpseed'); ?></h4>
            <div class="wpseed-component-showcase">
                <div class="positioning-demo">
                    <div class="positioning-grid">
                        <div class="position-item">
                            <span class="tooltip-trigger tooltip-top" data-tooltip="<?php esc_attr_e('Tooltip positioned above', 'wpseed'); ?>">
                                <?php esc_html_e('Top', 'wpseed'); ?>
                            </span>
                        </div>
                        <div class="position-item">
                            <span class="tooltip-trigger tooltip-right" data-tooltip="<?php esc_attr_e('Tooltip positioned to the right', 'wpseed'); ?>">
                                <?php esc_html_e('Right', 'wpseed'); ?>
                            </span>
                        </div>
                        <div class="position-item">
                            <span class="tooltip-trigger tooltip-bottom" data-tooltip="<?php esc_attr_e('Tooltip positioned below', 'wpseed'); ?>">
                                <?php esc_html_e('Bottom', 'wpseed'); ?>
                            </span>
                        </div>
                        <div class="position-item">
                            <span class="tooltip-trigger tooltip-left" data-tooltip="<?php esc_attr_e('Tooltip positioned to the left', 'wpseed'); ?>">
                                <?php esc_html_e('Left', 'wpseed'); ?>
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="component-demo">
            <h4><?php esc_html_e('Chart Data Tooltips', 'wpseed'); ?></h4>
            <div class="wpseed-component-showcase">
                <div class="chart-tooltip-demo">
                    <div class="mini-chart">
                        <div class="chart-header">
                            <h5><?php esc_html_e('AAPL - 1 Day Chart', 'wpseed'); ?></h5>
                        </div>
                    ...
                    <div class="chart-tooltip-template" style="display: none;">
                        <div class="chart-tooltip-content">
                            ...
                            <div class="tooltip-metrics">
                                <div class="tooltip-metric">
                                    <span class="metric-name"><?php esc_html_e('Price:', 'wpseed'); ?></span>
    ...
    $wpseed_tooltip_script = "
        jQuery(document).ready(function($) {
            ...
            $('.tooltip-trigger').on('mouseenter', function() {
                ...
                var tooltip = $('<div class=\"wpseed-tooltip\">' + tooltipText + '</div>');
                $('body').append(tooltip);
            ...
            $('.rich-tooltip-trigger').on('mouseenter', function() {
                ...
                var tooltip = $('<div class=\"wpseed-tooltip wpseed-rich-tooltip\"></div>');
            ...
            $('.interactive-tooltip-trigger').on('click', function(e) {
                ...
                $('.wpseed-interactive-tooltip').remove();
                
                var tooltip = $('<div class=\"wpseed-tooltip wpseed-interactive-tooltip\"></div>');
                tooltip.html(template.html());
                $('body').append(tooltip);
            ...
            $('.chart-point').on('mouseenter', function() {
                ...
                var tooltip = $('<div class=\"wpseed-tooltip wpseed-chart-tooltip\"></div>');
                tooltip.html(template.html());
                $('body').append(tooltip);
            ...
            $(document).on('click', function(e) {
                if (!$(e.target).closest('.wpseed-interactive-tooltip, .interactive-tooltip-trigger').length) {
                    $('.wpseed-interactive-tooltip').fadeOut(200, function() {
                        $(this).remove();
                    });
                }
            });
