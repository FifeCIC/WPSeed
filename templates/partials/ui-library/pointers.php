...
<div class="wpseed-ui-section">
    <h3><?php esc_html_e('WordPress Pointers', 'wpseed'); ?></h3>
    <p><?php esc_html_e('WordPress core pointer system for contextual help and guidance using wpseed pointer classes.', 'wpseed'); ?></p>
    
    <div class="wpseed-component-group">
        <!-- Left Header Pointer Demo -->
        <div class="component-demo">
            <h4><?php esc_html_e('Left Header Pointer', 'wpseed'); ?></h4>
            <div class="wpseed-component-showcase">
                <div style="display: flex; gap: 20px; align-items: flex-start;">
                    <div style="flex: 1; background: #f9f9f9; padding: 20px; border: 1px solid #ddd;">
                        <p><?php esc_html_e('Left content area', 'wpseed'); ?></p>
                    </div>
                    <div class="test-pointer-container" style="flex: 1; background: #fff; padding: 20px; border: 1px solid #ddd; position: relative;">
                        <h3><?php esc_html_e('Test Header', 'wpseed'); ?></h3>
                        <p><?php esc_html_e('This container simulates the directive configuration area.', 'wpseed'); ?></p>
                        <button class="button test-pointer-trigger"><?php esc_html_e('Show Pointer', 'wpseed'); ?></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="component-demo">
            <h4><?php esc_html_e('Pointer Positioning', 'wpseed'); ?></h4>
            <div class="wpseed-component-showcase">
                <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px; margin: 20px 0;">
                    <div class="pointer-test-box" data-position="left" style="background: #f0f0f0; padding: 15px; text-align: center; border: 1px solid #ccc;">
                        <h4><?php esc_html_e('Left Position', 'wpseed'); ?></h4>
                        <button class="button test-position-pointer"><?php esc_html_e('Test Left', 'wpseed'); ?></button>
                    </div>
                    <div class="pointer-test-box" data-position="right" style="background: #f0f0f0; padding: 15px; text-align: center; border: 1px solid #ccc;">
                        <h4><?php esc_html_e('Right Position', 'wpseed'); ?></h4>
                        <button class="button test-position-pointer"><?php esc_html_e('Test Right', 'wpseed'); ?></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- CSS Testing Area -->
        <div class="component-demo">
            <h4><?php esc_html_e('CSS Testing', 'wpseed'); ?></h4>
            <div class="wpseed-component-showcase">
                <textarea id="pointer-css-test" rows="8" style="width: 100%; font-family: monospace;">
.wpseed-left-header-pointer {
    margin-left: -15px !important;
}
.wpseed-left-header-pointer .wp-pointer-arrow {
    top: 20px !important;
}
                </textarea>
                <button class="button button-primary" id="apply-pointer-css"><?php esc_html_e('Apply CSS', 'wpseed'); ?></button>
                <button class="button" id="reset-pointer-css"><?php esc_html_e('Reset CSS', 'wpseed'); ?></button>
            </div>
        </div>
    </div>
        ...
        jQuery(document).ready(function($) {
            ...
            $('.test-pointer-trigger').on('click', function(e) {
                ...
                var options = {
                    ...
                    pointerClass: 'wp-pointer-right wpseed-left-header-pointer',
                    width: 320,
                    close: function() {
                        testPointer = null;
                    }
            ...
            $('#reset-pointer-css').on('click', function() {
                $('#dynamic-pointer-css').remove();
                $('#pointer-css-test').val('.wpseed-left-header-pointer {\\n    margin-left: -15px !important;\\n}\\n.wpseed-left-header-pointer .wp-pointer-arrow {\\n    top: 20px !important;\\n}');
            });
